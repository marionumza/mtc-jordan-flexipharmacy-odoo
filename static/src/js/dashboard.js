odoo.define('flexipharmacy.dashboard', function (require) {
    ...
    var ProductExpiryDashboard = Widget.extend(ControlPanelMixin, {
        ...
        expire_60_days : function (event){
            var self = this;
            self.do_action({
                   name : _t('Expire Product In 60-Days'),
                   views: [[false, 'list'],[false, 'form']],
        ...
        expire_30_days : function (event){
            var self = this;
            self.do_action({
                   name : _t('Expire Product In 30-Days'),
                   views: [[false, 'list'],[false, 'form']],
                   res_model: 'stock.production.lot',
                   type: 'ir.actions.act_window',
                   target: 'new',
        ...
        expire_15_days : function (event){
            var self = this;
            self.do_action({
                   name : _t('Expire Product In 15-Days'),
                   views: [[false, 'list'],[false, 'form']],
                   res_model: 'stock.production.lot',
                   type: 'ir.actions.act_window',
                   target: 'new',
        ...
        expire_10_days : function (event){
            var self = this;
            self.do_action({
                   name : _t('Expire Product In 10-Days'),
                   views: [[false, 'list'],[false, 'form']],
                   res_model: 'stock.production.lot',
                   type: 'ir.actions.act_window',
                   target: 'new',
        ...
        expire_5_days : function (event){
            var self = this;
            self.do_action({
                   name : _t('Expire Product In 5-Days'),
                   views: [[false, 'list'],[false, 'form']],
                   res_model: 'stock.production.lot',
                   type: 'ir.actions.act_window',
                   target: 'new',
        ...
        expire_tomorrow : function (event){
            var self = this;
            self.do_action({
                   name : _t('Tomorrow Expire Product'),
                   views: [[false, 'list'],[false, 'form']],
                   res_model: 'stock.production.lot',
                   type: 'ir.actions.act_window',
                   target: 'new',
           ...
           .then(function(records){
               ...
               var userList = new List('warehouse', options, values);
                   ...
                   for(var data=0;data<records['category_near_expire'].length;data++){
                        var html = "<div class='col-md-4 col-sm-6 col-xs-12 ng-scope custome_hide'>";
                   ...
                   $(document).ready(function () {
                        ...
                        $('#expire_in_60_days').click(function(){
                            self.expire_60_days(records['day_wise_expire']['60'])
                        });
                        $('#expire_in_30_days').click(function(){
                            self.expire_30_days(records['day_wise_expire']['30'])
                        });
                        $('#expire_in_15_days').click(function(){
                            self.expire_15_days(records['day_wise_expire']['15'])
                        });
                        $('#expire_in_10_days').click(function(){
                            self.expire_10_days(records['day_wise_expire']['10'])
                        });
                        $('#expire_in_5_days').click(function(){
                            self.expire_5_days(records['day_wise_expire']['5'])
                        });
                        $('#expire_in_tomorrow').click(function(){
                            self.expire_tomorrow(records['day_wise_expire']['1'])
                        });
